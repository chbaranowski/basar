...
<f:view>
	<h:form id="cashPoint">
		...
		<h1>Gewinn (ohne Teilnahmegebühr): <h:outputText id="gewinn" value="#{cashPointController.gewinn}"/> Euro</h1>
		<hr/><br/>
		...
		<p><h:commandLink immediate="true" value="Remote Import Positionen" action="remote"/></p>
		<p><a href="http://localhost:8080/beleg/abrechung.pdf?report=basar">Abrechnung</a></p>
		<p><a href="http://localhost:8080/beleg/uebersicht.pdf?report=uebersicht">Abrechnung - Übersicht</a></p>
